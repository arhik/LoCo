...
def get_imagenet1k_dataloader(opt):
    traindir = os.path.join(opt.data_input_dir, "imagenet", 'train')
    valdir = os.path.join(opt.data_input_dir, "imagenet", 'val')
    unsuperviseddir = os.path.join(opt.data_input_dir, "imagenet", 'unsupervised')
    ...
    #     [get_transforms(eval=False, aug=aug["imageget1k"])]
    # )
